...
class VideoList extends StatefulWidget{//自定义按钮组件
  final int index;
...
class _VideoListState extends State<VideoList>  with SingleTickerProviderStateMixin {  
  ...
  void goToDetail(String url){
    ...
    // Future<bool> delete = showDeleteConfirmDialog2();
    // if (delete == null) {
    //   print("取消删除");
    // } else {
  ...
  String FilterDateTime(String datetime){
    ...
    if(dt<10 && ds<10){
      return '0'+ dt.toString() +':0' + ds.toString();
    }else if(ds<10){
      return dt.toString() +':0' + ds.toString();
    }else if(dt<10){
      return '0'+ dt.toString() +':' + ds.toString();
    }else{
